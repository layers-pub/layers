...
- **Media space** (`boundingBox`, `spatioTemporalAnchor`): _where_ in an image or video frame an annotation occurs. Expressed as pixel coordinates. Used for anchoring annotations to media: "this object is at pixel (100, 50) with width 200 and height 150."

- **Semantic space** (`spatialExpression`): _what place or region_ a linguistic expression refers to. Expressed as geographic coordinates, named locations, or relative positions. Used for spatial annotation: "this expression refers to downtown Tokyo."
...
{
  "source": {
    "recordRef": "at://did:plc:.../pub.layers.annotation.annotationLayer/...",
    "objectId": { "value": "place-1-uuid" }
  },
  "target": {
    "recordRef": "at://did:plc:.../pub.layers.annotation.annotationLayer/...",
    "objectId": { "value": "place-2-uuid" }
  },
  "edgeType": "north-of",
  "label": "north of",
  "confidence": 950
