...
4. **`annotation.annotationLayer`** (lemma): `{ expression: <expression-uri>, kind: "token-tag", subkind: "lemma", annotations: [{ tokenIndex: 0, value: "the" }, ...] }`
5. **`annotation.annotationLayer`** (deps): `{ expression: <expression-uri>, kind: "relation", subkind: "dependency", formalism: "universal-dependencies", annotations: [{ headIndex: 1, targetIndex: 0, label: "det" }, ...] }`
