...
import type * as PubLayersGraphGraphEdge from './graphEdge'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.graph.listGraphEdges'
...
export interface RecordView {
  $type?: 'pub.layers.graph.listGraphEdges#recordView'
  uri: string
  cid: string
  value: PubLayersGraphGraphEdge.Main
}
