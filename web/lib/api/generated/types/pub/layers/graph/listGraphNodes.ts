...
import type * as PubLayersGraphGraphNode from './graphNode'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.graph.listGraphNodes'
...
export interface RecordView {
  $type?: 'pub.layers.graph.listGraphNodes#recordView'
  uri: string
  cid: string
  value: PubLayersGraphGraphNode.Main
}
