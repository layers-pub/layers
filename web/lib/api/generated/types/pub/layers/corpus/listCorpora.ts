...
import type * as PubLayersCorpusCorpus from './corpus'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.corpus.listCorpora'
...
export interface RecordView {
  $type?: 'pub.layers.corpus.listCorpora#recordView'
  uri: string
  cid: string
  value: PubLayersCorpusCorpus.Main
}
