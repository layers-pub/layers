...
import type * as PubLayersCorpusMembership from './membership'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.corpus.listMemberships'
...
export interface RecordView {
  $type?: 'pub.layers.corpus.listMemberships#recordView'
  uri: string
  cid: string
  value: PubLayersCorpusMembership.Main
}
