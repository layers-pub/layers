...
import type * as PubLayersMediaMedia from './media'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.media.listMedia'
...
export interface RecordView {
  $type?: 'pub.layers.media.listMedia#recordView'
  uri: string
  cid: string
  value: PubLayersMediaMedia.Main
}
