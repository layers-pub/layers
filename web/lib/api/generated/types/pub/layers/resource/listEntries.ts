...
import type * as PubLayersResourceEntry from './entry'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.resource.listEntries'
...
export interface RecordView {
  $type?: 'pub.layers.resource.listEntries#recordView'
  uri: string
  cid: string
  value: PubLayersResourceEntry.Main
}
