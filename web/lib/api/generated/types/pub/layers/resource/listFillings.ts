...
import type * as PubLayersResourceFilling from './filling'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.resource.listFillings'
...
export interface RecordView {
  $type?: 'pub.layers.resource.listFillings#recordView'
  uri: string
  cid: string
  value: PubLayersResourceFilling.Main
}
