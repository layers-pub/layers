...
import type * as PubLayersResourceTemplate from './template'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.resource.listTemplates'
...
export interface RecordView {
  $type?: 'pub.layers.resource.listTemplates#recordView'
  uri: string
  cid: string
  value: PubLayersResourceTemplate.Main
}
