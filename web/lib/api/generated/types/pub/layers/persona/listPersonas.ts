...
import type * as PubLayersPersonaPersona from './persona'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.persona.listPersonas'
...
export interface RecordView {
  $type?: 'pub.layers.persona.listPersonas#recordView'
  uri: string
  cid: string
  value: PubLayersPersonaPersona.Main
}
