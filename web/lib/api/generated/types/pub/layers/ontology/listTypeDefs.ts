...
import type * as PubLayersOntologyTypeDef from './typeDef'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.ontology.listTypeDefs'
...
export interface RecordView {
  $type?: 'pub.layers.ontology.listTypeDefs#recordView'
  uri: string
  cid: string
  value: PubLayersOntologyTypeDef.Main
}
