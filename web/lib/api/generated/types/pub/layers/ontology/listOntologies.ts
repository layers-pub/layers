...
import type * as PubLayersOntologyOntology from './ontology'

const is$typed = _is$typed,
  validate = _validate
const id = 'pub.layers.ontology.listOntologies'
...
export interface RecordView {
  $type?: 'pub.layers.ontology.listOntologies#recordView'
  uri: string
  cid: string
  value: PubLayersOntologyOntology.Main
}
