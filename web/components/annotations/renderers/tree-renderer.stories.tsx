    ...
    children: [
      {
        ...
        parentId: 'c-s',
        children: [
          { id: 'c-dt1', label: 'DT', parentId: 'c-np1', anchor: { type: 'tokenRef', tokenIndex: 0 } },
          { id: 'c-nn1', label: 'NN', parentId: 'c-np1', anchor: { type: 'tokenRef', tokenIndex: 1 } },
        ],
      },
      {
        id: 'c-vp',
        ...
        parentId: 'c-s',
        children: [
          { id: 'c-vbd', label: 'VBD', parentId: 'c-vp', anchor: { type: 'tokenRef', tokenIndex: 2 } },
          {
            id: 'c-pp',
            label: 'PP',
            parentId: 'c-vp',
            children: [
              { id: 'c-in', label: 'IN', parentId: 'c-pp', anchor: { type: 'tokenRef', tokenIndex: 3 } },
              {
                id: 'c-np2',
                label: 'NP',
                parentId: 'c-pp',
                children: [
                  { id: 'c-dt2', label: 'DT', parentId: 'c-np2', anchor: { type: 'tokenRef', tokenIndex: 4 } },
                  { id: 'c-nn2', label: 'NN', parentId: 'c-np2', anchor: { type: 'tokenRef', tokenIndex: 5 } },
                ],
              },
            ],
          },
...
const depItems: AnnotationItem[] = [
  { id: 'dep-0', label: 'det', anchor: { type: 'tokenRef', tokenIndex: 0 }, headIndex: 1, targetIndex: 0 },
  { id: 'dep-1', label: 'nsubj', anchor: { type: 'tokenRef', tokenIndex: 1 }, headIndex: 2, targetIndex: 1 },
  { id: 'dep-2', label: 'root', anchor: { type: 'tokenRef', tokenIndex: 2 }, headIndex: -1, targetIndex: 2 },
  { id: 'dep-3', label: 'case', anchor: { type: 'tokenRef', tokenIndex: 3 }, headIndex: 5, targetIndex: 3 },
  { id: 'dep-4', label: 'det', anchor: { type: 'tokenRef', tokenIndex: 4 }, headIndex: 5, targetIndex: 4 },
  { id: 'dep-5', label: 'obl', anchor: { type: 'tokenRef', tokenIndex: 5 }, headIndex: 2, targetIndex: 5 },
  { id: 'dep-6', label: 'punct', anchor: { type: 'tokenRef', tokenIndex: 6 }, headIndex: 2, targetIndex: 6 },
];
